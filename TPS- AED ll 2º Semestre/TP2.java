...
/*
* Funcao que retorna o numero de caracteres
* minusculos de uma string qualquer.	
*/
	...
	public static int Aquecimento(String s){
		...
		return Aquecimento(s,0,0);
	}

	public static int Aquecimento(String s, int cont , int resp){
		
		if( cont < s.length() ){
		
			if(s.charAt(cont) >= 'A' && s.charAt(cont) <= 'Z'){
				
				resp++;		
			}

			resp = Aquecimento(s,cont = cont + 1, resp);
		}
...
//=========================================================================================================//
	...
	public static String replaceAleatorio(String s, char atual, char novo){
	...
	public static String replaceAleatorio(String s, char atual, char novo ,String result, int cont){	
	...
	result = replaceAleatorio(s,atual,novo,result,cont = cont+1);
	}
...
class TP2{
	...
	public static void testeAquecimento(String [] entrada, int numEntrada){
		
		for(int i = 0; i <numEntrada; i++){	
			System.out.println(Funcao.Aquecimento(entrada[i]));	
	...
	public static void testePalindromo(String [] entrada, int numEntrada){
		...
		for(int i = 0; i <numEntrada; i++){	
			if(Funcao.isPalindromo(entrada[i]) == true){	
	...
	public static void testeConcatena(String [] entrada, int numEntrada){
		for(int i = 0; i<numEntrada -1; i+=2){
			System.out.println(Funcao.concatena(entrada[i],entrada[i+1]));
		}
		if(numEntrada % 2 == 1){
		System.out.println(Funcao.concatena(entrada[numEntrada -1],entrada[numEntrada -1]));
		}
	}
	...
	public static void testeReplace(String [] entrada,int numEntrada){
		...
		for(int i =0; i< numEntrada; i++){
			System.out.println(Funcao.replace(entrada[i],entrada[i].charAt(0),                                          entrada[i].charAt(entrada[i].length()-1)));
		}
	}
	...
	for(int i = 0; i < numEntrada; i++){
         ...
         System.out.println(Funcao.replaceAleatorio(entrada[i], entrada[i].charAt(0), teste));
      	}	
	}
	...
	public static void testeCompareTo(String[] entrada, int numEntrada){
		...
		for(int i = 0; i < numEntrada - 1; i+=2){
         		System.out.println(Funcao.compareTo(entrada[i],
         		entrada[i+1]) + " " + Funcao.compareToIgnoreCase(entrada[i],entrada[i+1])); 
      		}

      		if(numEntrada % 2 == 1){
         		System.out.println(Funcao.compareTo(entrada[numEntrada-1],
         		entrada[numEntrada-1]) + " "+ Funcao.compareToIgnoreCase(entrada  			                     [numEntrada-1],entrada[numEntrada-1])); 
      		}
   	}
	...
	public static void testeContar(String[] entrada, int numEntrada){
		...
		for(int i = 0; i < numEntrada; i++){
                	...
                	System.out.println(Funcao.contarCaractere(entrada[i],entrada[i].charAt(0)) +                                              " " + Funcao.contarLetra(entrada[i])                         +                                              " " + Funcao.contarNaoLetra(entrada[i])                      +                                              " " + Funcao.contarDoidao(entrada[i]));                     
      }
   }
	...
	public static void testeIs(String[] entrada, int numEntrada){
		...
		for(int i = 0; i < numEntrada; i++){
                	...
                	System.out.println(Funcao.isVogal(entrada[i]) +                                              " " + Funcao.isConsoante(entrada[i])                         +                                              " " + Funcao.isInteiro(entrada[i])                      +                                              " " + Funcao.isReal(entrada[i]));  
		}
	}
	...
	public static void testeConversao(String[] entrada, int numEntrada){
		...
		for(int i = 0; i < numEntrada; i++){
                	...
                	System.out.println(Funcao.toUpper(entrada[i]));
 			System.out.println(Funcao.toLower(entrada[i]));        
                        System.out.println(Funcao.trim(entrada[i]));
                        System.out.println(Funcao.trim(entrada[i],entrada[i].charAt(0)));  
		}
	}
	...
	public static void main (String [] args){
		...
		while(entrada[numEntrada++].equals("FIM") == false);
	        ...
	        //testeAquecimento(entrada,numEntrada);
		...
		//testeContar(entrada, numEntrada);
