...
class No {
   ...
   /**
     ...
     */
    No(Partida elemento, No esq, No dir, int nivel) {
...
class AVL {
   ...
   private No rotacionarEsq(No no) {
     ...
     */
    public void remover(Partida x) throws Exception {
        raiz = remover(raiz, x);
    }
    ...
    void questao3() throws Exception{
	...
	for(String nomeArquivo = MyIO.readLine(); nomeArquivo.equals("FIM") == false; nomeArquivo = 		MyIO.readLine()){
         ...
         do {
            ...
            if(tmp.contains("<tr>") == true){
               tree.inserir(Partida.readPartidaUsingArq());
            }
