...
//---------------------------------------------------------------------------------
     /**
     * class tabela rash direta rehash
...
class HashDR {
   ...
   HashDR (int tamanho){
      this.tamanho = tamanho;
      tabela = new PropriedadeArquivo[tamanho];
   ...
   boolean inserir (PropriedadeArquivo valor)throws Exception
   {
      boolean resp = false;
      int pos = funcaoTransformacao(valor.getTamanho());  
      int x = funcaoTransformacao(valor.getTamanho()+1);  
      if( tabela[pos].getTamanho() == 0 ) 
      {
       tabela[pos] = valor;
       resp = true;
      }
      else if ( tabela[x].getTamanho() == 0 ) 
      {
		tabela[x] = valor;
		resp = true;
       }
   ...
   boolean pesquisar(int x)
   {
    ...
    if(tabela[pos].getTamanho() == x )
    {
	resp = true;
     }
    else
    {
     pos = funcaoTransformacao(x + 1);
     if(tabela[pos].getTamanho() == x )
     {
      resp = true;
      }
...
//---------------------------------------------------------------------------------
    void questao6() throws Exception{
